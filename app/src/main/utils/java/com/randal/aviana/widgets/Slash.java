...
public class Slash extends View {
    ...
    private void setAttributeSet(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            mLineColor = typedArray.getColor(R.styleable.Slash_sl_color, DEFAULT_LINE_COLOR);
            mLineWidth = typedArray.getDimensionPixelOffset(R.styleable.Slash_sl_width, DEFAULT_LINE_WIDTH);
            mDirection = typedArray.getInt(R.styleable.Slash_sl_direction, DEFAULT_DIRECTION);
            typedArray.recycle();
        }
    }
}
